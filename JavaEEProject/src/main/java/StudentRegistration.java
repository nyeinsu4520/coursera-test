...
public class StudentRegistration extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<ul>");
        out.println("<li><span style='display:inline-block; width:150px;'>Email</span>" +": "+ email + "</li></ul>");
        ...
        out.println("<ul><li><span style='display:inline-block; width:150px;'>Year</span>" +": "+ year + "</li></ul>");
        out.println("<ul><li><span style='display:inline-block; width:150px;'>Hobbies</span>");
		if (hobbies != null) {
            boolean first = true;
